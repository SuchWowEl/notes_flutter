...
class NoteGiven extends ChangeNotifier {
  ...
  Future<Notes> fetchNote() async {
    ...
    return fetchNotes(number);
  }

  Future<Notes> fetchNotes(number) async {
    def = await database.loadNote(number);
    return def;
  }
  ...
  Future<void> updateNotesToDb(Notes noteReceived) async {
    await database.updateNote(noteReceived);
  ...
  void updateNotes(String title, content) {
    ...
    updateNotesToDb(
        Notes(id: def.id, title: title, date: "now", content: content));
  }
  ...
  void setDef() {
    def = const Notes(
        ...
        title: "",
        date: "now?",
        content: r'[{"insert": "default value\n"}]');
  }
}
                  ...
                  Consumer<NoteGiven>(
                    builder: (context, value, child) {
                      return IconButton(
                          ...
                          onPressed: () => value.updateNotes(controller.text,
